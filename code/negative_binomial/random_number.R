...
gganimate::animate(
  ...
  renderer = gganimate::av_renderer(file = "figure/negative_binomial/random_number/freq_1smp.mp4")
)
...
gganimate::animate(
  ...
  nframes = frame_num, fps = 10, 
  width = 12, height = 8, units = "in", res = 100, 
  renderer = gganimate::av_renderer(file = "figure/negative_binomial/random_number/relfreq_1smp.mp4")
)
...
gganimate::animate(
  ...
  nframes = frame_num, fps = 10, 
  width = 12, height = 8, units = "in", res = 100, 
  renderer = gganimate::av_renderer(file = "figure/negative_binomial/random_number/freq_nsmp.mp4")
)
...
gganimate::animate(
  ...
  nframes = frame_num, fps = 10, 
  width = 12, height = 8, units = "in", res = 100, 
  renderer = gganimate::av_renderer(file = "figure/negative_binomial/random_number/relfreq_nsmp.mp4")
)
