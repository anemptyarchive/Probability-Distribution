...
　多次元ガウス分布(Multivariate Gaussian Distribution)・多変量正規分布(Multivariate Normal Distribution)の確率密度を計算します。多次元ガウス分布については「分布の定義式」を参照してください。\
\
...
　多次元ガウス分布(Multivariate Gaussian Distribution)・多変量正規分布(Multivariate Normal Distribution)の乱数を生成します。多次元ガウス分布については「分布の定義式」を参照してください。\
\
...
　多次元ガウス分布(Multivariate Gaussian Distribution)・多変量正規分布(Multivariate Normal Distribution)から多次元ガウス分布を生成します。多次元ガウス分布については「分布の定義式」を参照してください。\
\
